        ...
        {tabs.map((tab) => (
          <ListItem key={tab.id} disablePadding sx={{ display: "block" }}>
            ...
            >
              ...
              {(!sidebarCollapsed || isMobile) && <ListItemText primary={tab.label} />}
            </NavButton>
          </ListItem>
        ))}
      </List>
    ...
    <DashboardContainer>
      ...
      <AppBar
        ...
        sx={{
          ...
          width: { md: `calc(100% - ${sidebarCollapsed ? SIDEBAR_WIDTH_COLLAPSED : SIDEBAR_WIDTH}px)` },
          ml: { md: sidebarCollapsed ? SIDEBAR_WIDTH_COLLAPSED : SIDEBAR_WIDTH },
      ...
      <Sidebar collapsed={sidebarCollapsed}>
        ...
        {!isMobile && (
          <ToggleSidebarButton onClick={handleSidebarToggle} size="small">
            {sidebarCollapsed ? <FiChevronRight style={{zIndex:"9999"}} /> : <FiChevronLeft style={{zIndex:"9999"}}/>}
          </ToggleSidebarButton>
        )}
      </Sidebar>
